...
// 管理员后台 - AI 配置（模型别名 / 目录同步 / 默认模型 / 租户配置 / 提供商多源管理 / 连接测试）
Route::prefix('ai')->group(function () {
    Route::middleware('rbac.permission:setting.view')->group(function () {
        ...
        Route::get('/providers', [AdminAiController::class, 'providerIndex']);
    ...
    Route::middleware('rbac.permission:setting.update')->group(function () {
        ...
        Route::post('/providers', [AdminAiController::class, 'providerStore']);
        Route::put('/providers/{providerId}', [AdminAiController::class, 'providerUpdate']);
        Route::delete('/providers/{providerId}', [AdminAiController::class, 'providerDestroy']);
